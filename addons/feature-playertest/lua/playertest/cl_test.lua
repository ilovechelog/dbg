...
-- 	},
	default = {
		name = 'Новый Кэмбридж',
		desc = [[Инженеры реконструириовали город, и он стал более лучше. Кэмбридж стал лучше, и теперь готов заново начал набирать новых жителей. В центре есть районный центр, и также промышленная зона

Благодаря маленькой карте автомобильная инфраструктура не развита, а слоты для игроков увеличены]],
	},
}
